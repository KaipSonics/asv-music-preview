  ...
  return (
    <main className="wrap">
      <header className="hero">
        ...
        <p>
          Смешивай элементы разных жанров, экспериментируй со звучанием и
          находи новые идеи. Собери вайб — остальное возьмём на себя.
        </p>
      </header>
      ...
      {history.length > 0 && !loading && (
        <section className="results">
          ...
          <div className="convert">
            <h3>Ты задал вектор — теперь отправь его нам и сделаем крутой продакшн</h3>
            <a
